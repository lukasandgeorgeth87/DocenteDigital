...
(function(){
  ...
  function create(){
    ...
    const html=meta+languageNote(lang,variety)+extra+body+
      `<div class="actions topgap dd-material-actions">
        <button class="btn" type="button" onclick="window.DDMaterials.downloadWord()">⬇ Word</button>
  ...
  css.textContent=`
    ...
    .dd-material-history{display:grid;gap:8px}.dd-material-history-item{display:flex;justify-content:space-between;gap:12px;align-items:center;border:1px solid #dce5e0;border-radius:12px;padding:11px;background:#fff}
  ...
  window.DDMaterials={create,useCurrent,duplicate,downloadWord,reopen,remove,fill,renderHistory};
